...
// TODO Это временный самописный контейнер, который будет заменен на \DI\Container
...
//            $this->getInstance($this->container[$containerKey], $parameters) :
...
//     */
//    private function getInstance($className, array $parameters)
//    {
...
//
//        if (is_null($constructMethod) && empty($parameters)) {
